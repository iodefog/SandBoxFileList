#
#  Be sure to run `pod spec lint SandBoxFileList.podspec' to ensure this is a
...
或者
  ...
  s.homepage     = "https://github.com/lihongli528628/SendSandBoxFileDemo"
  ...
  # s.authors            = { "lihongli" => "honglili@sohu-inc.com" }
  ...
  s.source_files  = "Classes", "SendLogs/*.{h,m}"
